...
public class DoublyLinkedList<T> implements ListOf<T> {
     ...
     * @param val
     * @param c
     * @preCondition val is a value of type T and c is a Cursor
     * @postCondition the DoublyLinkedList is mutated in that it now contains
     *                the inserted value with the cursor now in front of the
     *                inserted value
     */
     ...
     * 
     * @param val
     * @preConditions val is a value of type T
     ...
     * @postCondition the list now has one less element as the element that was
     *                in front of the cursor is now removed
     */
    ...
    /**
     * get returns the value of the node in front of the cursor (node cursor ->
     * node <- returns that one)
     * 
     * @param c
     * @preCondition c is a Cursor
     ...
     *         location, false otherwise
     * @postCondition true if another node present in list behind current
     *                location
     */
     ...
     * @param c1
     * @param c2
     * @preCondition c1 and c2 are Cursors
     * @postcondition the list is mutated such that the value that was at c1 is
     *                now located at c2 and the value that was located at c2 is
     *                now located at c1
     */
     ...
     * @param c
     * @param pred
     * @preCondition c is a Cursor and pred is a Predicate
     * @return true if a value that satisfies the predicate is found, false
     *         otherwise
     * @postCondition if true is returned, the cursor is moved to the location
     *                of the item. If false is returned, the cursor is returned
     ...
     * 
     * @param pred
     * @preCondition pred is a Predicate
    ...
    /**
     * subList creates a list of elements that is a sublist of the parent list
     * 
     * @param start
     * @param end
     * @preCondition start is a Cursor that marks the first element wanted in
     *               sublist end is a Cursor that marks the last element
     *               inclusive
     ...
     *                front of start and behind end. The cursor that denotes the
     *                front of the sublist remains in its original position.
     * 
     */
     ...
     *                and both cursors remain in the same location in which they
     *                started
     */
