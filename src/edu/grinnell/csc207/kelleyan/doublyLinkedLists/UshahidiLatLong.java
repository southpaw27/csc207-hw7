...
public class UshahidiLatLong extends DoublyLinkedList {
	 ...
	 * @param incidents, a DoublyLinkedList of UshahidiIncidents
	 * @preConditions all the incidents should have valid latitudes and longitudes
	 ...
	 * @param pred, a PredicateTwo<Double>
	 * @return a list of UshahidiIncidents
	 * @preCondition all values in incidents must have valid latitudes and longitudes
	...
	(DoublyLinkedList<UshahidiIncident> incidents, PredicateTwo<Double> pred) 
			throws Exception {
		DoublyLinkedListIterator<UshahidiIncident> it = 
				new DoublyLinkedListIterator<UshahidiIncident>(incidents);
		DoublyLinkedList<UshahidiIncident> sel = 
...
/**
 * extracts a DoublyLinkedList of all the UshahidiIncidents within distance of the average
 * latitude and longitude of the list
 * @param incidents, a DoublyLinkedList of UshahidiIncidents
 * @param distance, a distance in degrees away
 * @return a DoublyLinkedList of the specified UshahidiIncidents
 * @throws Exception
 */
	public static DoublyLinkedList<UshahidiIncident> 
	extractNearby(DoublyLinkedList<UshahidiIncident> incidents,
			Double distance) throws Exception {
		Double[] averages = avLatLong(incidents);
		return(selectNearby(incidents, new Nearby(distance, averages[0], averages[1])));
	}
	...
	public static void printIncidentList(PrintWriter pen,
		...
		for (UshahidiIncident val : list) {
			printIncident(pen, (edu.grinnell.glimmer.ushahidi.UshahidiIncident) val);
		} // for
		pen.println();
		pen.flush();
	...
	public static void main(String[] args0) throws Exception{
        ...
        //remove the first location with an unsupported latitude and longitude
        ...
        DoublyLinkedList<UshahidiIncident> nearby = extractNearby(incidents, new Double(50));
